...
public class ObjectPlayer extends GameObject{    
    ...
    public ObjectPlayer(double x, double y, double sizeX, double sizeY, Game game, BufferedImage collisionImage){
        super(x,y,GameObjectID.Player, sizeX, sizeY, collisionImage);        
        this.game = game;        
