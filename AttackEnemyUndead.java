...
public class AttackEnemyUndead extends ObjectAttack{
    ...
    public AttackEnemyUndead(GameObject object, double x, double y, double duration, double angle) {
        super(object.handler, x, y, 0, new ImageLoader().loadImage("res/coll_circle_48x48.png"), duration);        
